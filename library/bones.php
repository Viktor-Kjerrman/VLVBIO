...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'swiper', get_template_directory_uri() . '/library/js/libs/idangerous.swiper-2.0.min.js', array(), '', TRUE );

    wp_register_script( 'cookieJQ', get_template_directory_uri() . '/library/js/libs/jquery-cookie.js', array(), '', TRUE );
...
/*    wp_register_script( 'referees-js', get_template_directory_uri() . '/library/js/referees.js', array( 'jquery' ), '', true );

    wp_register_script('backbone', get_template_directory_uri() . '/library/js/libs/backbone.js', array(), '', true );

    wp_register_script('underscore', get_template_directory_uri() . '/library/js/libs/underscore.js', array(), '', true );
*/
    ...
    */
    ...
    wp_enqueue_script('cookieJQ' );
/*    wp_enqueue_script('backbone');
    wp_enqueue_script('underscore');
    wp_enqueue_script('referees-js'); */
  }
}
